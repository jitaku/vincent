...
function exec(){
    // Generated by CoffeeScript 1.10.0
(function() {
  var BackgroundAPIBuilder, BufferObject, Collection, DummyModel, ErrorDoc, Errors, EventEmitter, ForegroundModel, IPCConnection, IPCDataDenormalizable, IPCDataNormalizable, Key, KeyEventManager, Leaf, List, MessageCenter, Model, ModelProvidable, ModelReceivable, Mouse, Namespace, ProviderLayer, ProviderModelManager, Publishable, ReadableStream, ReadyAware, ReceiverLayer, RestApiFactory, SharedCallbacks, States, Subscribable, TemplateManager, Trait, Util, Widget, WidgetBase, WritableStream, _browserInfo, exports, i, index,
    slice = [].slice,
    indexOf = [].indexOf || function(item) { for (var i = 0, l = this.length; i < l; i++) { if (i in this && this[i] === item) return i; } return -1; },
    extend = function(child, parent) { for (var key in parent) { if (hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; },
    hasProp = {}.hasOwnProperty,
...
(function(){
var require = VincentContext.requireModule.bind(VincentContext,"vincent/facility/comConverter.js");
var module = {};
module.exports = {};
var exports = module.exports;
function exec(){
...
VincentContext.setModule("vincent/facility/comConverter.js",module,exec);
})();
(function(){
...
(function(){
var require = VincentContext.requireModule.bind(VincentContext,"vincent/facility/htmlTag.js");
var module = {};
module.exports = {};
var exports = module.exports;
function exec(){
...
VincentContext.setModule("vincent/facility/htmlTag.js",module,exec);
})();
(function(){
